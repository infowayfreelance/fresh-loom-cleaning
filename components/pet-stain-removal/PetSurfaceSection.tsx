      ...
      <div className="container-page grid lg:grid-cols-2 gap-12 items-center mb-14">
        ...
        <Reveal direction="right" delay={0.1}>
          <div className="relative w-full aspect-[4/3] rounded-3xl overflow-hidden shadow-xl">
            <Image src="/images/pet-stains-on-different-furnishings.webp" alt="Pet stains affecting different types of furnishings" fill sizes="(min-width: 1024px) 50vw, 100vw" className="object-cover" />
          </div>
        </Reveal>
      </div>
